    ...
    return (
        <div className="w-full">
            {weather && weather?.weather ? (
                <Card className={`w-full mt-2 p-4 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 border-1 ${getWeatherBackground(weather.weather[0].id).borderColor}`}>
                    <video
                        autoPlay
                        muted
                        loop
                    ...
                    <div className="relative z-10 rounded-xl">
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <p className="text-md">{capitalize(weather.weather[0].description.toString())}</p>
                            </div>
